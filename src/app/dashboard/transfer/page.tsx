    ...
    <div className="max-w-7xl mx-auto">
      ...
      >
        ...
        <p className="text-[rgb(var(--muted-foreground))]">
          Send, claim, and manage secure transfers on the Hedera Testnet
        </p>
      </motion.div>
          ...
          >
            <div className="card backdrop-blur-lg border border-[rgb(var(--border))]/50 p-6" ref={formRef}>
              ...
              <form onSubmit={handleSendTransfer} className="space-y-4">
                ...
                {success && (
                  <div className="bg-orange-500/10 border border-orange-500/50 text-orange-700 dark:text-orange-300 p-4 rounded-xl">
                    <p>{success}</p>
                  </div>
                )}
              ...
              <div className="mt-6 pt-6 border-t border-[rgb(var(--border))]/50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    ...
                    { icon: ArrowRightIcon, text: "Send on the Hedera Testnet" },
