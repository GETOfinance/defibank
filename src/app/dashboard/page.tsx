          ...
          <div>
            ...
            <div className="flex items-center space-x-2 text-xs text-[rgb(var(--muted-foreground))]">
              ...
              <span className={`px-2 py-0.5 rounded-full text-xs ${
                ...
                activity.status === 1 ? 'bg-orange-500/20 text-orange-400' :
    ...
    <div className="max-w-6xl mx-auto">
      ...
      >
        ...
        <p className="text-[rgb(var(--muted-foreground))]">
          Welcome to DeFi Bank. Your secure crypto transfer platform.
        </p>
      </motion.div>
        ...
        {showUsernameModal && (
          ...
          >
            ...
            >
              ...
              <p className="text-[rgb(var(--muted-foreground))] mb-4">
                Choose a username to make receiving payments easier. Your username will be used for receiving payments on Hedera Testnet.
              </p>
