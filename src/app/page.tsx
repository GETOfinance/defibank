    ...
    >
      ...
      <motion.div style={{ y, opacity }} className="relative z-10 w-full max-w-6xl mx-auto">
        <motion.div
          ...
          animate="animate"
        >
          <div className="bg-white/30 dark:bg-black/30 p-4 md:p-8 rounded-3xl backdrop-blur-xl border border-gray-200 dark:border-orange-500/20 hover:border-orange-500/40 transition-all duration-500 shadow-sm">
            <ShieldCheckIcon className="w-16 h-16 md:w-24 md:h-24 text-orange-500 dark:text-orange-400" />
          </div>
        </motion.div>
        ...
        <motion.h1 
          ...
          variants={fadeIn}
        >
          <span className="bg-gradient-to-r from-orange-500 via-orange-400 to-orange-600 dark:from-orange-400 dark:via-orange-300 dark:to-orange-500 text-transparent bg-clip-text">
            DeFi Bank
          </span>
        </motion.h1>
        ...
        <motion.div 
          ...
          variants={fadeIn}
        >
          <Link href="/dashboard/transfer" className="group relative bg-orange-500 text-white px-8 md:px-12 py-4 md:py-5 rounded-xl md:rounded-2xl font-semibold text-lg md:text-xl transition-all duration-300 flex items-center justify-center space-x-3">
            <span className="relative z-10">Transfer Now</span>
            <ArrowRightIcon className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            <div className="absolute inset-0 rounded-xl md:rounded-2xl bg-orange-400 blur-md group-hover:opacity-70 transition-opacity opacity-0" />
          </Link>
        </motion.div>
        ...
        >
          {[
            ...
            >
              <item.icon className="w-5 h-5 md:w-6 md:h-6 text-orange-500 group-hover:text-orange-600 dark:text-orange-400 dark:group-hover:text-orange-300 transition-colors" />
              <span className="group-hover:text-orange-600 dark:group-hover:text-orange-300 transition-colors">{item.text}</span>
            </motion.div>
          ))}
        </motion.div>
      </motion.div>

      <div className="absolute top-1/4 left-1/4 w-48 h-48 md:w-96 md:h-96 bg-orange-500/10 dark:bg-orange-500/20 rounded-full blur-[100px] animate-pulse" />
      <div className="absolute bottom-1/4 right-1/4 w-48 h-48 md:w-96 md:h-96 bg-orange-600/10 dark:bg-orange-600/20 rounded-full blur-[100px] animate-pulse delay-1000" />
    </motion.section>
  );
};
    ...
    >
      <div className="container mx-auto flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center space-x-2">
          <ShieldCheckIcon className="w-8 h-8 text-orange-500 dark:text-orange-400" />
...
const ChainSlider = () => {
  const chains = [
    { name: 'Hedera', icon: '/chains/hedera.svg' },
  ];
    ...
    <section id="chains" className="py-16 relative overflow-hidden">
      <div className="container mx-auto px-4 mb-10">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Seamlessly send and receive HBAR on the Hedera Testnet with the same secure DeFi Bank experience.
        </motion.p>
      </div>
              ...
              {chains.map((chain, index) => (
                <div key={`chain-${copyIndex}-${index}`} className="slide">
                  <div className="logo-wrapper group">
                    ...
                    />
                    <div className="logo-name opacity-70 group-hover:opacity-100 group-hover:text-orange-500 dark:group-hover:text-orange-400">
                      {chain.name}
                    </div>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="mt-1 p-2 bg-orange-500/10 rounded-lg">
                  <QrCodeIcon className="w-6 h-6 text-orange-500 dark:text-orange-400" />
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-orange-600 dark:text-orange-400 mb-2">QR Upload & Scan</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-orange-600 dark:text-orange-400 mb-2">Refundable Payments</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-orange-600 dark:text-orange-400 mb-2">Username Payments</h3>
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 bg-orange-500/20 blur-3xl rounded-full opacity-30" />
              <div className="relative bg-white/40 dark:bg-black/40 backdrop-blur-xl p-6 md:p-8 rounded-2xl border border-gray-200 dark:border-orange-500/30 shadow-xl">
                <div className="bg-white/70 dark:bg-black/70 rounded-xl overflow-hidden shadow-2xl">
                  <div className="p-4 bg-orange-50 dark:bg-orange-900/30 border-b border-orange-100 dark:border-orange-500/30 flex items-center justify-between">
                  ...
                  <div className="p-6">
                    <div className="mb-6 text-center">
                      <motion.div
                        ...
                        animate="animate"
                      >
                        <ShieldCheckIcon className="w-16 h-16 text-orange-500 dark:text-orange-400 mx-auto mb-4" />
                      </motion.div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-gray-50 dark:bg-black/50 p-4 rounded-lg border border-gray-100 dark:border-orange-500/20">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="text-orange-600 dark:text-orange-400">crypto.user</div>
                          <UserCircleIcon className="w-5 h-5 text-orange-500 dark:text-orange-400" />
                        </div>
                      </div>
                      ...
                      <div className="bg-gray-50 dark:bg-black/50 p-4 rounded-lg border border-gray-100 dark:border-orange-500/20">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="text-orange-600 dark:text-orange-400">0.5 {nativeToken}</div>
                          <CurrencyDollarIcon className="w-5 h-5 text-orange-500 dark:text-orange-400" />
                        </div>
                      </div>
