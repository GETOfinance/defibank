      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="relative group">
            <motion.div
              className="absolute -inset-2 bg-gradient-to-r from-orange-500/20 to-orange-600/20 rounded-lg blur-lg group-hover:opacity-100 opacity-0 transition-opacity duration-300"
              animate={{
                scale: [1, 1.1, 1],
                opacity: [0, 0.5, 0],
              }}
            ...
            />
            <motion.span
              className="relative text-2xl font-bold bg-gradient-to-r from-orange-400 to-orange-600 text-transparent bg-clip-text"
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
            >
              <div className="absolute inset-0 bg-gradient-to-r from-orange-500 to-orange-600 transition-all duration-300 group-hover:opacity-100 opacity-90" />
          ...
          <motion.button
            ...
            className="md:hidden relative p-2 rounded-xl bg-black/20 backdrop-blur-sm border border-orange-500/20"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
        ...
        <AnimatePresence>
          {isMenuOpen && (
            ...
            >
              <div className="bg-black/80 backdrop-blur-xl rounded-2xl border border-orange-500/20 p-4 space-y-2">
                {navItems.map((item) => (
                  <Link key={item.href} href={item.href}>
                    <motion.div
                ...
                <motion.button
                  ...
                  className="w-full flex items-center space-x-2 px-4 py-3 rounded-xl font-medium bg-gradient-to-r from-orange-500 to-orange-600 text-white"
